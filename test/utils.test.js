...
test('time to test a function', (expect) => {
    ...
    const expected = `<div class="movie"><img class="movie-cover" src="../assets/jurassicpark.jpg"><p class="movie-title">Jurassic Park</p></div>`;
